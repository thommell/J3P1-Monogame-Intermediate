...
public class Interactable : GameObject
{
    ...
    public Interactable(Vector2 pPosition, Texture2D pTexture, Rectangle pRectangle, Vector2 pOrigin, Player pPlayer, Game1 pGame) : base(pPosition, pTexture, pRectangle, pOrigin)
    {
        _player = pPlayer;
        _game1 = pGame;
    }
